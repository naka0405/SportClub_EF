...
namespace SportClub
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //clientCardManager.AddClientCard(new ClientCardBL() { FirstName = "Yulia", LastName = "Liapina", Telephone = 099789456,
            //   Training = new List<TrainingKind> { swimingPool, fitness } });
            ...
            var groups = groupManager.GetGroupsByTrainingId(1);
